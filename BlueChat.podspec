#
#  Be sure to run `pod spec lint BlueChat.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Max Zou" => "zouchaoqun@gmail.com" }
  # Or just: s.author    = "Max Zou"
  # s.authors            = { "Max Zou" => "zouchaoqun@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Max Zou"
  ...
  s.source       = { :git => "https://github.com/zouchaoqun/BlueChat.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "BlueChatLib/BlueChatLib/**/*.{h,m}"
  s.exclude_files = "BlueChatLib/BlueChatLib/BlueChatLib.h"
